...
<tiles:insertDefinition name="template">
	<tiles:putAttribute name="corpo">
		...
		<springform:form method="post"
			action="${pageContext.request.contextPath}/protected/produto/cadastrar.do"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<springform:input id="id_produto" path="id_produto"
						cssClass="form-control" placeholder="Código do produto"
						autofocus="true" required="true" maxlength="20" />
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-md-1 control-label" for="nomeUnidade">Unidade:</label>
				<div class="col-md-4">
