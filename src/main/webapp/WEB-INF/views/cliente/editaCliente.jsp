...
<tiles:insertDefinition name="template">
	<tiles:putAttribute name="corpo">
		...
		<springform:form method="post"
			action="${pageContext.request.contextPath}/protected/cliente/edit.do"
			...
			<springform:hidden path="id_cliente" />

			

			<input type="submit" value="Salvar" class="btn btn-primary" />
			
			<a href="${pageContext.request.contextPath}/protected/cliente/listar.do">
