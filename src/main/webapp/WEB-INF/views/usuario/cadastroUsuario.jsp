...
<tiles:insertDefinition name="template">
	<tiles:putAttribute name="corpo">
		...
		<springform:form method="post"
			action="${pageContext.request.contextPath}/protected/usuario/cadastrar.do"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<springform:password id="senha" path="senha"
						cssClass="form-control" placeholder="Senha" required="true" maxlength="48"/> 
				</div>
			</div>
		  	<div class="form-group">
			...
			<a href="${pageContext.request.contextPath}/protected/usuario/listar.do"> <input
				type="button" value="Cancelar" class="btn btn-default" />
			</a>
